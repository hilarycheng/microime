...
char *inputMethodList[4] = {
  "/data/data/com.diycircuits.microime/lib/libquick.so",
  "/data/data/com.diycircuits.microime/lib/libcangjie3.so",
  "/data/data/com.diycircuits.microime/lib/libstroke.so",
  0
};
...
struct _INPUT_METHOD_LIST {
  ...
  { "1", "/data/data/com.diycircuits.microime/lib/libquick.so",     "quick_func",     "速成" },
  { "0", "/data/data/com.diycircuits.microime/lib/libcangjie3.so",  "cangjie_func",   "倉頡3" },
  { "2", "/data/data/com.diycircuits.microime/lib/libcangjie3.so",  "cangjie_func",   "倉頡3(香港字)" },
  { "4", "/data/data/com.diycircuits.microime/lib/libcangjie5.so",  "cangjie5_func",  "倉頡5" },
  { "3", "/data/data/com.diycircuits.microime/lib/libstroke.so",    "stroke_func",    "筆劃" },
  { "5", "/data/data/com.diycircuits.microime/lib/libdayi3.so",     "dayi3_func",     "大易三碼" },
  { "6", "/data/data/com.diycircuits.microime/lib/libcantonese.so", "cantonese_func", "廣東話拼音" },
  { 0, 0, 0}
};
...
void Java_com_diycircuits_microime_TableLoader_setupOnce(JNIEnv *env, jobject thiz)
{
  int count = 0;
  jstring str;
...
void Java_com_diycircuits_microime_TableLoader_setPath(JNIEnv *env, jobject thiz, jbyteArray path)
{
...
void Java_com_diycircuits_microime_TableLoader_initialize(JNIEnv* env, jobject thiz)
{
...
void Java_com_diycircuits_microime_TableLoader_reset(JNIEnv* env, jobject thiz)
{
...
jchar Java_com_diycircuits_microime_TableLoader_getChar(JNIEnv* env, jobject thiz)
{
  /* int count = 0; */
...
jchar Java_com_diycircuits_microime_TableLoader_passCharArray(JNIEnv* env, jobject thiz, jcharArray arr)
{
...
jint Java_com_diycircuits_microime_TableLoader_getMaxKey(JNIEnv* env, jobject thiz)
{
...
void Java_com_diycircuits_microime_TableLoader_setInputMethod(JNIEnv* env, jobject thiz, jchar im)
{
  if (mCurrentIm != im) {
    mCurrentIm = im;
    loadInputMethod(im);
...
void Java_com_diycircuits_microime_TableLoader_searchCangjie(JNIEnv* env, jobject thiz, jchar key0, jchar key1, jchar key2, jchar key3, jchar key4)
{
...
void Java_com_diycircuits_microime_TableLoader_searchCangjieMore(JNIEnv* env, jobject thiz, jcharArray key0, jcharArray key1, jcharArray key2, jcharArray key3, jcharArray key4)
{
  jchar key0array[6];
  jchar key1array[6];
  jchar key2array[6];
...
void Java_com_diycircuits_microime_TableLoader_enableHongKongChar(JNIEnv* env, jobject thiz, jboolean hk)
{
  mEnableHK = hk;
...
jboolean Java_com_diycircuits_microime_TableLoader_tryMatchCangjie(JNIEnv* env, jobject thiz, jchar key0, jchar key1, jchar key2, jchar key3, jchar key4)
{
...
jboolean Java_com_diycircuits_microime_TableLoader_trySearchWord(JNIEnv* env, jobject thiz, jcharArray key, jint len)
{
...
void Java_com_diycircuits_microime_TableLoader_searchWord(JNIEnv* env, jobject thiz, jcharArray key, jint len)
{
  memset(keyStorage, 0, sizeof(keyStorage));
  (*env)->GetCharArrayRegion(env, key, 0, 64, keyStorage);
...
jboolean Java_com_diycircuits_microime_TableLoader_tryMatchCangjieMore(JNIEnv* env, jobject thiz, jcharArray key0, jcharArray key1, jcharArray key2, jcharArray key3, jcharArray key4)
{
  jchar key0array[6];
  jchar key1array[6];
  jchar key2array[6];
...
jint Java_com_diycircuits_microime_TableLoader_totalMatch(JNIEnv* env, jobject thiz)
{
...
jchar Java_com_diycircuits_microime_TableLoader_getMatchChar(JNIEnv* env, jobject thiz, jint index)
{
...
jint Java_com_diycircuits_microime_TableLoader_getFrequency(JNIEnv* env, jobject thiz, jint index)
{
...
jint Java_com_diycircuits_microime_TableLoader_updateFrequency(JNIEnv* env, jobject thiz, jchar ch)
{
...
void Java_com_diycircuits_microime_TableLoader_saveMatch(JNIEnv* env, jobject thiz)
{
...
void Java_com_diycircuits_microime_TableLoader_clearAllFrequency(JNIEnv *env, jobject thiz)
{
...
jint Java_com_diycircuits_microime_TableLoader_searchPhrase(JNIEnv *env, jobject thiz, jchar ch)
{
  /* jchar charray[16]; */
...
jint Java_com_diycircuits_microime_TableLoader_getPhraseCount(JNIEnv *env, jobject thiz)
{
  /* LOGE("Get Phrase Count"); */
  return get_phrase_count();
}

jint Java_com_diycircuits_microime_TableLoader_getPhraseIndex(JNIEnv *env, jobject thiz)
{
  /* LOGE("Get Phrase Index"); */
  return get_phrase_index();
}

jint Java_com_diycircuits_microime_TableLoader_getPhraseMax(JNIEnv *env, jobject thiz)
{
  /* LOGE("Get Phrase Max"); */
  return get_phrase_max();
}

jint Java_com_diycircuits_microime_TableLoader_getAllPhraseMax(JNIEnv *env, jobject thiz)
{
  return MAX_PHRASE_LENGTH;
}

void Java_com_diycircuits_microime_TableLoader_getPhrase(JNIEnv *env, jobject thiz, jint index, jobject sb)
{
...
jint Java_com_diycircuits_microime_TableLoader_getPhraseArray(JNIEnv *env, jobject thiz, jint index, jcharArray phrase)
{
...
jint Java_com_diycircuits_microime_TableLoader_measurePhraseRow(JNIEnv *env, jobject thiz,
...
void Java_com_diycircuits_microime_TableLoader_updatePhraseFrequency(JNIEnv *env, jobject thiz, jint idx)
{
  update_phrase_frequency(idx);
}

jint Java_com_diycircuits_microime_TableLoader_getPhraseFrequency(JNIEnv *env, jobject thiz, jint idx)
{
  return get_phrase_frequency(idx);
}

void Java_com_diycircuits_microime_TableLoader_learnPhrase(JNIEnv *env, jobject thiz, jchar key, jchar value)
{
  learn_phrase(key, value);
}

void Java_com_diycircuits_microime_TableLoader_setSortingMethod(JNIEnv *env, jobject thiz, jint method)
{
...
jint Java_com_diycircuits_microime_TableLoader_getInputMethodCount(JNIEnv *env, jobject thiz)
{
  return inputMethodCount;
}

jobject Java_com_diycircuits_microime_TableLoader_getInputMethodNameList(JNIEnv *env, jobject thiz)
{
  return _inputMethodNameList;
}

jobject Java_com_diycircuits_microime_TableLoader_getInputMethodIndexList(JNIEnv *env, jobject thiz)
{
